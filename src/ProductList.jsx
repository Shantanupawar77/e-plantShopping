...
function ProductList() {
   ...
   const handleCartClick = (e) => {
    ...
    const calcTotalQuant = () =>{
        return cartCount ? cartCount.reduce((total, item) => total + item.quantity, 0) : 0;
    };

    const [totalQuantity, setTotalQuantity] = useState(calcTotalQuant());
    useEffect(() => {
        // Update total quantity whenever cartItems change
        setTotalQuantity(calcTotalQuant());
    }, [cartCount]);
